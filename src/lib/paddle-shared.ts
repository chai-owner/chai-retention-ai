...
/** Human-readable price IDs created via the payments tools (stable test/live). */
export const PLAN_PRICE_IDS: Record<OrgPlan, Record<BillingPeriod, string>> = {
  core: { monthly: "core_monthly", annual: "core_annual" },
...
/** Price external ID -> plan + billing period. */
