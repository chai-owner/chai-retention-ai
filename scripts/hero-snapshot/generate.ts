...
const accounts = [
  { id: "ACC-101", name: "Harbour & Finch Accounting", monthly: 1200, lastInvoice: 12, invoices: [1200, 1200, 1200, 1200, 1200, 1200], tickets: [["closed", 9], ["closed", 8]] },
  { id: "ACC-102", name: "Ridgeway Physio Group", monthly: 850, lastInvoice: 20, invoices: [850, 850, 850, 850, 850, 850], tickets: [["closed", 8]] },
  { id: "ACC-103", name: "Oakline Studio", monthly: 640, lastInvoice: 25, invoices: [640, 640, 640, 640, 640], tickets: [["closed", 7], ["closed", 9]] },
  { id: "ACC-104", name: "Brightside Dental", monthly: 980, lastInvoice: 8, invoices: [980, 980, 980, 980, 980, 980], tickets: [] },
  { id: "ACC-105", name: "Meadowbank Logistics", monthly: 2100, lastInvoice: 118, invoices: [2100, 1900, 1400, 900], tickets: [["open", 3], ["reopened", 4], ["open", 5], ["closed", 6]] },
  { id: "ACC-106", name: "Tidewater Legal", monthly: 1500, lastInvoice: 45, invoices: [1500, 1500, 1500, 1500, 1500], tickets: [["closed", 7], ["open", 6]] },
  { id: "ACC-107", name: "Copperfield Veterinary", monthly: 720, lastInvoice: 30, invoices: [720, 720, 720, 720, 720], tickets: [["closed", 8]] },
  { id: "ACC-108", name: "Northgate Property Co.", monthly: 1750, lastInvoice: 16, invoices: [1750, 1750, 1750, 1750, 1750, 1750], tickets: [["closed", 9]] },
] as const;
...
const dataset = buildRealDataset({ customers, transactions, support }, { ...DEFAULT_METRIC_WEIGHTS }, null);
